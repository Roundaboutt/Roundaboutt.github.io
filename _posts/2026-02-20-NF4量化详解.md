...
![96c84f85c32f87d66196b9b8078d1907](\images\NF4量化详解\1.png)
...
![image-20260306200323900](\images\NF4量化详解\2.png)

warp 全都在 stall wait 和 stall branch resolving，也就是大部分时间都在空闲！

我们打开source，看看问题具体出在哪一行代码上。

![image-20260306201202066](\images\NF4量化详解\3.png)

![image-20260306201222765](\images\NF4量化详解\4..png)
...
![image-20260306202639670](\images\NF4量化详解\5.png)
...
-   带宽没满？—— 赶紧改代码，上向量化，上 ILP，上预取，别让 GPU 闲着
    ...
    ![image-20260306204409019](\images\NF4量化详解\6.png)
...
![image-20260306205708419](\images\NF4量化详解\7.png)
...
![image-20260306223052039](\images\NF4量化详解\10.png)

内存利用率提高了非常多。

![image-20260306223157234](\images\NF4量化详解\11.png)
...
![image-20260307132349192](\images\NF4量化详解\12.png)
...
![image-20260307133010026](\images\NF4量化详解\13.png)

可以看到，stall not selected 和 stall math pip throttle都已经下降。

但是 stall long scoreboard 怎么这么高？别急，我们来看看 GPU Throughput：

![image-20260307133122052](\images\NF4量化详解\14.png)

内存带宽几乎拉满了！

再看看roofline：

![image-20260307133212735](\images\NF4量化详解\15.png)
...
![4c110f347fe212d9a6139a7307bcf1ed](\images\NF4量化详解\16.png)
